...
const char* ssid = "Kost Bahagia";
const char* password = "TUGASAKHIR2023";
//======================================== 
...
String serverName = "192.168.0.12";  //--> Change with your server computer's IP address or your Domain name.
